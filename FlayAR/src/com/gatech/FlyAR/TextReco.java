...
import com.gatech.FlyAR.TextRecoRenderer.WordDesc;
    ...
    void configureVideoBackgroundROI()
    {
        ...
        
        {
           ...
           // int marginWidth = mIsTablet ? (screenWidth * 20) / 100
            //    : (screenWidth * 5) / 100;
        	int marginWidth=(screenWidth*20)/100;
           ...
           // int loupeHeight = mIsTablet ? (screenHeight * 10) / 100
             //   : (screenHeight * 15) / 100;
        	int loupeHeight=(screenHeight*50)/100;
        ...
        runOnUiThread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                if (words.size() > 0)
                {
                    ...
                    for(WordDesc word : words)
                    {
                    	if(word.text.equalsIgnoreCase("register"))
                    	{
                    		System.out.println("inside Register");
                    		/*Intent intent=new Intent(TextReco.this,MainActivity.class);
                    		Intent intent1 = new Intent(TextReco.this, GestureReco.class);
                    		Intent[] list = new Intent[2];
                    		list[0] = intent;
                    		list[1] = intent1;
                    		startActivities(list); */
                    		Intent intent=new Intent(TextReco.this,GestureReco.class);
                    		intent.putExtra("TextVal", word.text);
