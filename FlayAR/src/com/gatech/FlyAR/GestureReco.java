...
public class GestureReco extends Activity implements CameraGestureSensor.Listener {
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
	    ...
	    String webText = extras.getString("TextVal");
	    TextView myAwesomeTextView = (TextView)findViewById(R.id.myAwesomeTextView);
	    myAwesomeTextView.setText(webText);
	...
	runOnUiThread(new Runnable() {
			...
			public void run() {
				...
				onPause();
				Intent intent=new Intent(GestureReco.this,MainActivity.class);
